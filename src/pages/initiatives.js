...
const content = {
    ...
    fullWidthImage: {
        ...
        body: 'Like the soil, sunshine, and rain that create world-class wines along Napa Valley\'s Silverado Trail, the three stages of our accelerator model allow good ideas to grow into action-oriented policy initiatives.',
    },
    copy: {
